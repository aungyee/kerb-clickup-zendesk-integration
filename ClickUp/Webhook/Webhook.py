...
def handleTaskCreatedEvent(payload: dict) -> flask.Response:
    ...
    if taskDetail['list']['id'] == LIST_ID['CUSTOMER_SUPPORT_GENERAL']:
        newTicket = Zendesk.API.Tickets.API.createTicketFromTask(taskDetail, GROUP_IDS['CUSTOMER_SUCCESS_TEAM'])
...
def handleTechSupportTaskCreatedEvent(payload):
    pass
